...
locals {
  ...
  user_attribute_update_settings = length(var.attributes_require_verification_before_update) > 0 ? { attributes_require_verification_before_update = var.attributes_require_verification_before_update } : {}
}
